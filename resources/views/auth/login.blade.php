...
<img src="{{ asset('img/clinics-logo.png') }}" alt="Logo Image" class="dashboard-img img-fluid">
   <h1 class="welcome-text">{{ trans('global.hi_Welcome') }}</h1><br>
   <h6 class="welcome-under-text">{{ trans('global.more_Effectively') }}</h6><br><br>
    ...
    <div class="col-md-3">
        <div class="card mx-4">
            <div class="card-body p-4 login-card-body">
                <h3 class="sign-text">{{ trans('global.sign_In_Message') }}</h3>     
              <div> <span class="sign-under-text"> {{ trans('global.dont_Account') }}</span>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var currentLanguage = urlParams.get('change_language');
