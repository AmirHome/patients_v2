...
<div class="container">
    ...
    <div class="content">
        <p>Merhaba,</p>
        <p>Hastamızla ilgili bilgiler linktedir. Görüntülemek için lütfen <a href="{{$data['link']}}">linke tıklayınız.</a></p>
        <p>Dönüşünüzü rica eder, iyi çalışmalar dileriz.</p>
        <p>CLINICS - International Patient Center</p>
    </div>
