...
@includeIf('admin.contentCategories.relationships.delete_modal')
...
<div class="card">
    ...
    <div class="card-body" style="padding: 40px 16.6% 40px 0px; !important;margin:0px !important">
        <table class=" table table-bordered table-hover ajaxTable datatable datatable-ContentCategory">
            <thead>
                <tr>
                    <th width="10">
