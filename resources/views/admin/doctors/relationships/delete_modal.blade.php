<!-- GUIDE Modal Body -->
<div class="modal fade" id="delete_modal_doctors" tabindex="-1" role="dialog"
...
@parent
    <script>
            $('#delete_modal_doctors').on('show.bs.modal', function(event) {
            var button = $(event.relatedTarget);
            var rowId = button.data('id') ?? 0;

            $('#delete_modal_doctors').on('click', 'button.submit[type="button"]', function() {
                // get form in this div
                var form =  $('#delete_modal_doctors').find('form');
