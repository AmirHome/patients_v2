                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                            ...
                            @if($errors->has('surname'))
                                <div class="invalid-feedback">
                                {{ str_replace('surname', trans('global.surname'), $errors->first('surname')) }}
                                </div>
                            @endif
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control {{ $errors->has('height') ? 'is-invalid' : '' }}" type="number" name="height" id="height"  step="1">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control {{ $errors->has('weight') ? 'is-invalid' : '' }}" type="number" name="weight" id="weight"  step="1">
