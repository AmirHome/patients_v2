...
<div class="card">
    ...
    <span class="help-block">{{ trans('cruds.patient.fields.code_helper') }}</span>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('surname') ? 'is-invalid' : '' }}" type="text" name="surname" id="surname" value="{{ old('surname', $patient->surname) }}" placeholder="Surname.."  required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mother_name') ? 'is-invalid' : '' }}" type="text" name="mother_name" id="mother_name" value="{{ old('mother_name', $patient->mother_name) }}" placeholder="Mother Name.."  required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('father_name') ? 'is-invalid' : '' }}" type="text" name="father_name" id="father_name" value="{{ old('father_name', $patient->father_name) }}" placeholder="Father Name.."  required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('passport_no') ? 'is-invalid' : '' }}" type="text" name="passport_no" id="passport_no" value="{{ old('passport_no', $patient->passport_no) }}" placeholder="Passport No.."  required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('passport_origin') ? 'is-invalid' : '' }}" type="text" name="passport_origin" id="passport_origin" value="{{ old('passport_origin', $patient->passport_origin) }}" placeholder="Passport Origin.."  required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="text" name="phone" id="phone" value="{{ old('phone', $patient->phone) }}" placeholder="Phone.."  required>
                @if($errors->has('phone'))
                    <div class="invalid-feedback">
                        {{ $errors->first('phone') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('foriegn_phone') ? 'is-invalid' : '' }}" type="text" name="foriegn_phone" id="foriegn_phone" value="{{ old('foriegn_phone', $patient->foriegn_phone) }}" placeholder="Foreign Phone.." required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $patient->email) }}" placeholder="Email.." required>
                @if($errors->has('email'))
                    <div class="invalid-feedback">
                        {{ $errors->first('email') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('birth_place') ? 'is-invalid' : '' }}" type="text" name="birth_place" id="birth_place" value="{{ old('birth_place', $patient->birth_place) }}" placeholder="Birth Place.." required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('weight') ? 'is-invalid' : '' }}" type="number" name="weight" id="weight" value="{{ old('weight', $patient->weight) }}" placeholder="Weight.." step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('height') ? 'is-invalid' : '' }}" type="number" name="height" id="height" value="{{ old('height', $patient->height) }}" placeholder="Height.." step="0.01" required>
            ...
            <div class="col-md-3">
                ...
                <input class="form-control {{ $errors->has('citizenship') ? 'is-invalid' : '' }}" type="text" name="citizenship" id="citizenship" placeholder="Citizenship.." value="{{ old('citizenship', $patient->citizenship) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('treating_doctor') ? 'is-invalid' : '' }}" type="text" name="treating_doctor" id="treating_doctor" placeholder="Treating Doctor.." value="{{ old('treating_doctor', $patient->treating_doctor) }}">
          ...
          <div class="col-md-12">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" name="address" id="address" placeholder="Description.." required>{{ old('address', $patient->address) }}</textarea>
