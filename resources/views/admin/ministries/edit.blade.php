    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.ministries.update", [$ministry->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" placeholder="Enter Name.." type="text" name="name" id="name" value="{{ old('name', $ministry->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('code') ? 'is-invalid' : '' }}"  placeholder="Enter Code.." type="text" name="code" id="code" value="{{ old('code', $ministry->code) }}" required>
                @if($errors->has('code'))
                    <div class="invalid-feedback">
                        {{ $errors->first('code') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('code_inc') ? 'is-invalid' : '' }}"  placeholder="Enter Code Inc.." type="number" name="code_inc" id="code_inc" value="{{ old('code_inc', $ministry->code_inc) }}" step="1" required>
