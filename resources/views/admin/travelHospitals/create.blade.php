<div class="modal fade" id="create-travel-hospital" tabindex="-1" role="dialog"  aria-hidden="true" >
    <div class="modal-dialog modal-lg" role="document">
        ...
        <form method="POST" action="{{ route("admin.travel-hospitals.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="card-header">{{ trans('cruds.Other.create_travel_hospital') }}</div>
            ...
            <div class="row">
                ...
                <span class="login-info">{{ trans('cruds.Other.comma_separator_example') }} <strong> info@gmail.com, info@hotmail.com </strong></span> </div>
</div>
</div>
            <div class="row">
                <div class="col-md-6">
