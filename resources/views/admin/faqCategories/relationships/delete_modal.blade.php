<!-- GUIDE Modal Body -->
<div class="modal fade" id="delete_modal_faq-categories" tabindex="-1" role="dialog"
    aria-labelledby="customerDocumentCreateModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content" style="margin-top:30vh;">
            <form action="{{ route('admin.faq-categories.destroy', [0]) }}" method="POST">
...
@parent
    <script>
            $('#delete_modal_faq-categories').on('show.bs.modal', function(event) {
