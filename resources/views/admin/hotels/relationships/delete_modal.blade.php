...
@parent
    <script>
            $('#delete_modal_hotels').on('show.bs.modal', function(event) {
            var button = $(event.relatedTarget);
            var rowId = button.data('id') ?? 0;

            $('#delete_modal_hotels').on('click', 'button.submit[type="button"]', function() {
                // get form in this div
                var form =  $('#delete_modal_hotels').find('form');
