...
<div class="tab-content">
        ...
        <div class="card-header pb-5">
         ...
         <div class="col-md-3">
            <div class="form-group">
               ...
               <input class="form-control {{ $errors->has('height') ? 'is-invalid' : '' }}" placeholder="Boyu" type="number" name="height" id="height" value="{{ old('height', $patient->height??null) }}" step="0.01" required>
         ...
         <div class="col-md-3">
            <div class="form-group">
               ...
               <input class="form-control {{ $errors->has('mother_name') ? 'is-invalid' : '' }}" type="text" placeholder="Anne adı" name="mother_name" id="mother_name" value="{{ old('mother_name', $patient->mother_name??null) }}" required>
         ...
         <div class="col-md-3">
            <div class="form-group">
               ...
               <input class="form-control {{ $errors->has('father_name') ? 'is-invalid' : '' }}" type="text" name="father_name" placeholder="Baba adı" id="father_name" value="{{ old('father_name', $patient->father_name??null) }}" required>
         ...
         <div class="col-md-3">
            <div class="form-group">
               ...
               <input class="form-control {{ $errors->has('middle_name') ? 'is-invalid' : '' }}" type="text" name="middle_name" placeholder="ikinci ismi" id="middle_name" value="{{ old('middle_name', $patient->middle_name??null) }}" required>
         ...
         <div class="col-md-3">
            <div class="form-group">
               ...
               <input class="form-control {{ $errors->has('citizenship') ? 'is-invalid' : '' }}" type="text" placeholder="Memleketi" name="citizenship" id="citizenship" value="{{ old('citizenship', $patient->citizenship??null) }}" required>
         ...
         <div class="col-md-3">
            <div class="form-group">
               ...
               <input class="form-control {{ $errors->has('birth_place') ? 'is-invalid' : '' }}" type="text" placeholder="Doğum yeri" name="birth_place" id="birth_place" value="{{ old('birth_place', $patient->birth_place??null) }}" required>
         ...
         <div class="col-md-3">
            <div class="form-group">
               ...
               <input class="form-control date {{ $errors->has('birthday') ? 'is-invalid' : '' }}" placeholder="Doğum Günü" type="text" name="birthday" id="birthday" value="{{ old('birthday', $patient->birthday??null) }}">
         ...
         <div class="col-md-3">
            <div class="form-group">
               <label class="required" for="email">{{ trans('cruds.patient.fields.email') }}</label>
               <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email"  placeholder="Email" name="email" id="email" value="{{ old('email', $patient->email??null) }}" required>
               @if($errors->has('email'))
               <div class="invalid-feedback">
                  {{ $errors->first('email') }}
               </div>
         ...
         <div class="col-md-3">
            <div class="form-group">
               ...
               <input class="form-control {{ $errors->has('foriegn_phone') ? 'is-invalid' : '' }}" placeholder="Yabancı telefon no" type="text" name="foriegn_phone" id="foriegn_phone" value="{{ old('foriegn_phone', $patient->foriegn_phone??null) }}" required>
         ...
         <div class="col-md-3">
            <div class="form-group">
               ...
               <input class="form-control {{ $errors->has('reffering') ? 'is-invalid' : '' }}" placeholder="Referans" type="text" name="reffering" id="reffering" value="{{ old('reffering', $travel->reffering) }}">
         ...
         <div class="col-md-3">
            <div class="form-group">
               ...
               <select class="form-control select2 {{ $errors->has('campaign_org') ? 'is-invalid' : '' }}" placeholder="Kampanya Kanalı" name="campaign_org_id" id="campaign_org_id">
         ...
         <div class="col-md-3">
            <div class="form-group">
               ...
               <input class="form-control {{ $errors->has('treating_doctor') ? 'is-invalid' : '' }}" placeholder="Tedavi eden doktor" type="text" name="treating_doctor" id="treating_doctor" value="{{ old('treating_doctor', $patient->treating_doctor??null) }}">
  ...
  <div class="card-header d-flex justify-content-between align-items-center">
      <div>Raporlar</div>
      <button type="button" class="btn btn-xs btn-success" data-toggle="modal" data-target="#activities_add_modal">
      {{ trans('global.add') }}
      </button>
  </div>
...
<!--Reports-->
<div class="modal fade" id="activities_add_modal" tabindex="-1" role="dialog"
    aria-labelledby="customerDocumentCreateModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
  ...
  <div class="row justify-content-end">
        <div class="form-group">
            <button type="button" class="btn btn-outline-primary" id="cancelButton4" >{{ trans('global.cancel') }}</button>
        </div>
        <div class="form-group">
            <button class="btn btn-danger mx-3" type="submit">{{ trans('global.save') }}</button>
        </div>
</div>
            </form>
        </div>
...
$(document).ready(function() {
    $('#cancelButton4').click(function() {
         var modal = $('#activities_add_modal');
        modal.removeClass('show').css('display', 'none');
        modal.attr('aria-hidden', 'true');
