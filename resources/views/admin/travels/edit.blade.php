    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.travels.update", [$travel->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('reffering') ? 'is-invalid' : '' }}" type="number" name="reffering" id="reffering" value="{{ old('reffering', $travel->reffering) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('reffering_type') ? 'is-invalid' : '' }}" type="text" name="reffering_type" id="reffering_type" value="{{ old('reffering_type', $travel->reffering_type) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('reffering_other') ? 'is-invalid' : '' }}" type="text" name="reffering_other" id="reffering_other" value="{{ old('reffering_other', $travel->reffering_other) }}">
