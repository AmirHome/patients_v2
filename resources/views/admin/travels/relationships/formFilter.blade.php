...
<div class="card-header-text">
        <h3 class="text-left pb-3 font-weight-bold">Vakalar</h3>
    </div>
<div class="card card-table">
<h4 class="form-title-text pt-4 pl-3 font-weight-bold">Vaka Listeleme</h4>
    <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        <input type="text" class="form-control form-text-input filter" placeholder="Hasta Kodu"
                            name="patient_code">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <input type="text" class="form-control form-text-input filter" placeholder="Hasta Adı"
                            name="patient_name">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <select class="form-control form-text-input filter" wire:model.live="gender">
                ...
                <!-- <div class="col-md-5">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-text-input filter" placeholder="Enter last name" name="surname">
            ...
            <div class="row">
                ...
                <!-- <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control form-text-input filter" placeholder="Enter your birthday"
                            name="birthday">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-text-input filter" placeholder="Enter your birth place"
                            name="birth_place">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-text-input filter" placeholder="Enter your mother name"
                            name="mother_name">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-text-input filter" placeholder="Enter your father name"
                            name="father_name">
            ...
            <!-- <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-text-input filter" placeholder="Enter weight" name="weight">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-text-input filter" placeholder="Enter height" name="height">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select class="form-control form-text-input filter" wire:model.live="blood_group">
                ...
                <!-- <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-text-input filter" name="treating_doctor">
                        </select>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select class="form-control form-text-input filter" wire:model.live="compaignChannelId">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select class="form-control form-text-input filter" wire:model.live="campaign_org_id">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select class="form-control form-text-input filter" wire:model.live="reffering_type">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-text-input filter" placeholder="Enter citizenship"
                            name="citizenship">
                ...
                <!-- <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-text-input filter" placeholder="Enter your passport no"
                            name="passport_no">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-text-input filter" placeholder="Enter your passport origin"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control form-text-input filter" placeholder="Enter your birth place"
                            name="passport_image">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control form-text-input filter" placeholder="Enter email address" name="email">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-text-input filter" placeholder="Enter your phone" name="phone">
                ...
                <!-- <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-text-input filter" placeholder="Enter your foriegn phone"
                            name="foriegn_phone">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <select class="form-control form-text-input filter" wire:model.live="countryId">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select class="form-control form-text-input filter" wire:model.live="city_id">
