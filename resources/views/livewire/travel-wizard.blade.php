                                    ...
                                    <div class="row px-5">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group" wire:ignore>
                                                ...
                                                <div class="mt-2 needsclick dropzone {{ $errors->has('treatment_file') ? 'is-invalid' : '' }} d-flex flex-column align-items-center justify-content-center" id="treatment_file-dropzone">
