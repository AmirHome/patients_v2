...
class UsersController extends Controller
{
    ...
    public function show(User $user)
    {
        ...
        $user->load('office', 'roles', 'team', 'userPatients', 'userTravelTreatmentActivities', 'userActivities', 'userCrmCustomers', 'userCrmDocuments', 'userTasks', 'userExpenses', 'userIncomes', 'userUserAlerts');
