...
class TaskController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = Task::with(['status', 'assigned_to', 'team'])->select(sprintf('%s.*', (new Task)->table));
            ...
            $table->editColumn('created_at', function ($row) {
                return $row->created_at ? $row->created_at->format(config('panel.date_format')) : '';
            });

            $table->rawColumns(['actions', 'placeholder', 'status', 'assigned_to', 'attachment']);
    ...
    public function create()
    {
        ...
        return view('admin.tasks.create', compact('assigned_tos', 'statuses'));
    }
    ...
    public function edit(Task $task)
    {
        ...
        $task->load('status', 'assigned_to', 'team');

        return view('admin.tasks.edit', compact('assigned_tos', 'statuses', 'task'));
    }
