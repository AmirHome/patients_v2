...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-userCrmCustomers">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($crmCustomers as $key => $crmCustomer)
                        <tr data-entry-id="{{ $crmCustomer->id }}">
                            ...
                            <td>
                                {{ $crmCustomer->campaign->started_at ?? '' }}
                            </td>
                            <td>
                                {{ $crmCustomer->user->name ?? '' }}
                            </td>
                            <td>
                                {{ $crmCustomer->user->email ?? '' }}
                            </td>
                            <td>
...
@endcan
  ...
  let table = $('.datatable-userCrmCustomers:not(.ajaxTable)').DataTable({ buttons: dtButtons })
